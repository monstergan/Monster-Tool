package com.monster.core.log.logger;

import com.monster.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class MonsterLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": KteLogger init success!");
	}
