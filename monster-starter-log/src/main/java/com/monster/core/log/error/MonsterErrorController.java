 ...
 * 更改html请求异常为ajax
 */
public class MonsterErrorController extends BasicErrorController {

	public MonsterErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
