package com.monster.core.http.util;

import com.monster.core.http.Exchange;
import com.monster.core.http.FormBuilder;
import com.monster.core.http.HttpRequest;
...
public class HttpUtil {
    ...
    public static String putJson(String url, Map<String, String> header, String json) {
        return putExchange(url, header, json).asString();
    }

    public static Exchange putExchange(String url, Map<String, String> header, String content) {
