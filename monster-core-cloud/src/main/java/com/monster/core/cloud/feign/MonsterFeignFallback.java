...
@Slf4j
@AllArgsConstructor
public class MonsterFeignFallback<T> implements MethodInterceptor {
    ...
    public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        ...
        log.error("KteFeignFallback:[{}.{}] serviceId:[{}] message:[{}]", targetType.getName(), method.getName(), targetName, errorMessage);
    ...
    public boolean equals(Object o) {
        ...
        MonsterFeignFallback<?> that = (MonsterFeignFallback<?>) o;
