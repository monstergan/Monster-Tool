...
import com.monster.core.cloud.http.logger.HttpLoggingInterceptor;
import com.monster.core.cloud.http.logger.OkHttpSlf4jLogger;
import com.kte.core.tool.ssl.DisableValidationTrustManager;
import com.kte.core.tool.ssl.TrustAllHostNames;
import com.kte.core.tool.utils.Charsets;
import com.kte.core.tool.utils.Holder;
...
@ConditionalOnProperty(value = "kte.http.enabled", matchIfMissing = true)
public class RestTemplateConfiguration {
    private final MonsterHttpProperties properties;
    ...
    @RequiredArgsConstructor
    @ConditionalOnClass(OkHttpClient.class)
    @ConditionalOnProperty(value = "kte.http.rest-template.enable")
    ...
    @RequiredArgsConstructor
    @ConditionalOnClass(OkHttpClient.class)
    @ConditionalOnProperty(value = "kte.http.lb-rest-template.enable")
