...
import com.monster.core.cloud.hystrix.MonsterHystrixAutoConfiguration;
...
/**
 * 自动配置
 * Create by monster gan on 2023/3/13 15:01
 */
@NoArgsConstructor
public class MonsterFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return MonsterHystrixAutoConfiguration.class;
    }
