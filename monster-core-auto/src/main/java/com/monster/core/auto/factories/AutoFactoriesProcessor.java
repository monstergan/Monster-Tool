package com.monster.core.auto.factories;

import com.monster.core.auto.annotation.AutoIgnore;
import com.monster.core.auto.common.AbstractKteProcessor;
import com.monster.core.auto.common.BootAutoType;
import com.monster.core.auto.common.MultiSetMap;
...
public class AutoFactoriesProcessor extends AbstractKteProcessor {
	 ...
	 * Feign 自动配置
	 */
	private static final String FEIGN_AUTO_CONFIGURE_KEY = "com.kte.core.cloud.feign.KteFeignAutoConfiguration";
	/**
