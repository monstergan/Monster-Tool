...
@AllArgsConstructor
@EnableConfigurationProperties(MonsterHttpCacheProperties.class)
@ConditionalOnProperty(value = "kte.http.cache.enabled", havingValue = "true")
public class HttpCacheConfiguration implements WebMvcConfigurer {
    ...
    private final MonsterHttpCacheProperties properties;
