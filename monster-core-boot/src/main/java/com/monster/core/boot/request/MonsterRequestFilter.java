 ...
 */
@AllArgsConstructor
public class MonsterRequestFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		// 默认 Request 包装
			...
			MonsterHttpServletRequestWrapper kteRequest = new MonsterHttpServletRequestWrapper((HttpServletRequest) request);
			chain.doFilter(kteRequest, response);
		}
		// Xss Request 包装
		else {
