 ...
 * 全局Request包装
 */
public class MonsterHttpServletRequestWrapper extends HttpServletRequestWrapper {
	...
	public MonsterHttpServletRequestWrapper(HttpServletRequest request) {
		super(request);
		orgRequest = request;
	}
	...
	public static HttpServletRequest getOrgRequest(HttpServletRequest request) {
		if (request instanceof MonsterHttpServletRequestWrapper) {
			return ((MonsterHttpServletRequestWrapper) request).getOrgRequest();
		}
		return request;
	}
