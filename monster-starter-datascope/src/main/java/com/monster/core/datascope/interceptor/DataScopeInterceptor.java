package com.monster.core.datascope.interceptor;

import com.baomidou.mybatisplus.core.toolkit.PluginUtils;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.monster.core.datascope.annotation.DataAuth;
...
public class DataScopeInterceptor implements QueryInterceptor {
    ...
    public void intercept(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) {
        ...
        //未取到用户则放行
        MonsterUser MonsterUser = AuthUtil.getUser();
        if (MonsterUser == null) {
            return;
        }
        ...
        //获取数据权限规则对应的筛选Sql
        String sqlCondition = dataScopeHandler.sqlCondition(mapperId, dataScope, MonsterUser, originalSql);
