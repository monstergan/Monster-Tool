...
import com.monster.core.tool.spel.MonsterExpressionEvaluator;
import com.monster.core.tool.utils.CharPool;
...
public class RedisLockAspect implements ApplicationContextAware {
     ...
     * 表达式处理
     */
    private static final MonsterExpressionEvaluator EVALUATOR = new MonsterExpressionEvaluator();
    /**
     * redis 限流服务
     */
    ...
    public Object aroundRedisLock(ProceedingJoinPoint point, RedisLock redisLock) {
        ...
        if (redisLock.explicitFail()) {
            return redisLockClient.explicitFailLock(lockKey, lockType, waitTime, leaseTime, timeUnit, redisLock.message(), point::proceed);
        }
