...
import com.monster.core.tool.function.CheckedSupplier;
...
public interface RedisLockClient {
    ...
    /**
     * @see RedisLockClient#lock(String, LockType, long, long, TimeUnit, CheckedSupplier)
     * 加锁超时抛出RedisLockException 异常信息com.kte.core.redis.lock.RedisLock#message()
     */
    <T> T explicitFailLock(String lockName, LockType lockType, long waitTime, long leaseTime, TimeUnit timeUnit, String message, CheckedSupplier<T> supplier);
}
