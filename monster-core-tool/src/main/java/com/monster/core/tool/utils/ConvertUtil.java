...
import com.monster.core.tool.convert.MonsterConversionService;
import org.springframework.core.convert.TypeDescriptor;
import org.springframework.core.convert.support.GenericConversionService;
import org.springframework.lang.Nullable;

/**
 * 基于 spring ConversionService 类型转换工具类
 * <p>
 * Create on 2023/3/13 10:39
 * @author monster gan
 */
public class ConvertUtil {
    ...
    public static <T> T convert(@Nullable Object source, Class<T> targetType) {
        ...
        GenericConversionService conversionService = MonsterConversionService.getInstance();
