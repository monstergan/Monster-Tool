...
/**
 * Create by monster gan on 2023/3/13 11:17
 */
public class MonsterExpressionEvaluator extends CachedExpressionEvaluator {
    ...
    public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
        ...
        MonsterExpressionRootObject rootObject = new MonsterExpressionRootObject(method, args, target, targetClass, targetMethod);
