...
import com.monster.core.tool.jackson.MonsterJavaTimeModule;
...
@EnableConfigurationProperties(MonsterJacksonProperties.class)
public class JacksonConfiguration {
	...
	public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
		...
		//日期格式化
		objectMapper.registerModule(MonsterJavaTimeModule.INSTANCE);
