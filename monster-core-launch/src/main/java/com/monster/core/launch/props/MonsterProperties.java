 ...
 * 配置文件
 * <p>
 * Create  on 2023/3/13 13:44
 *
 * @author monster gan
 */
@ConfigurationProperties("kte")
public class MonsterProperties implements EnvironmentAware, EnvironmentCapable {
    ...
    public String getEnv() {
        ...
        String env = environment.getProperty("kte.env");
        Assert.notNull(env, "请使用 KteApplication 启动...");
        return env;
    }
    ...
    public String getName() {
        Objects.requireNonNull(environment, "Spring boot 环境下 Environment 不可能为null");
        return environment.getProperty("spring.application.name", environment.getProperty("kte.name", ""));
    }
