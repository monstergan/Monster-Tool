...
import com.monster.tenant.annotation.TableExclude;
...
public class MonsterTenantHandler implements TenantLineHandler, SmartInitializingSingleton {
    /**
     * 匹配的多租户表
     */
     ...
     * 需要排除进行自定义的多租户表
     */
    private final List<String> excludeTableList = Arrays.asList("kte_user", "kte_dept", "kte_role", "kte_tenant", "act_de_model");
    /**
     * 多租户配置
     */
    private final MonsterTenantProperties tenantProperties;
    ...
    public boolean ignoreTable(String tableName) {
        if (MonsterTenantHolder.isIgnore()) {
            return true;
        }
