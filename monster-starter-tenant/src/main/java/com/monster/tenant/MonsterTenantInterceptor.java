...
public class MonsterTenantInterceptor extends TenantLineInnerInterceptor {
     ...
     * 租户配置文件
     */
    private MonsterTenantProperties tenantProperties;
    /**
     * 超管需要启用租户过滤的表
     */
    private List<String> adminTenantTables = Arrays.asList("kte_top_menu", "kte_dict_biz");
    ...
    protected void processPlainSelect(PlainSelect plainSelect) {
        ...
        if (fromItem instanceof Table) {
            ...
            if (!tenantLineHandler.ignoreTable(fromTable.getName()) && (!doTenantFilter(fromTable.getName()))) {
                //#1186 github
